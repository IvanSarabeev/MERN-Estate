...
const PropertyOverview: React.FC<PropertyOverviewProps> = ({ data }) => {
  ...
  return (
    <div className="w-full md:w-8/12 h-fit gap-y-4 md:gap-y-6 lg:gap-y-8 xl:gap-y-10 flexColStart">
      <aside className="w-full h-fit gap-y-2.5 md:gap-y-4 lg:gap-y-6 gap-x-4 md:gap-x-6 lg:gap-x-8 xl:gap-x-10 grid grid-cols-3 xl:grid-cols-5 rounded-md shadow-md px-10 py-8 shadow-slate-100 bg-slate-900/90">
